...
@Configuration
@MapperScan(basePackages = {"com.maxplus1.spark.demo.java.dao.test2db"}, sqlSessionFactoryRef = "test2dbSqlSessionFactory")
public class Test2dbConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("test2db") DataSource dataSource) throws Exception {
        ...
        factoryBean.setTypeAliasesPackage("com.maxplus1.spark.demo.java.entity");
